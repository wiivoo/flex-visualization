# Flex Visualization - Codex Guidance

This file is the short entry point for repo-local Codex behavior. Keep it concise and defer detail to the canonical docs below.
