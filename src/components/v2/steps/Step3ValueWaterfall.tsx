...
export function Step3ValueWaterfall({ annualDayAhead, valueEstimates, setValueEstimates, optimization, onNext, onBack }: Props) {
  ...
  return (
    <div className="space-y-6">
                ...
                {viewMode === 'total' ? (
                  <BarChart data={waterfallData} margin={{ top: 20, right: 20, bottom: 20, left: 0 }}>
                    ...
                    <Tooltip
                      ...
                      formatter={(val) => val != null ? [`${val} EUR/year`, 'Value'] : ['-', 'Value']}
                    />
                    {/* Invisible base bar */}
      ...
      <div className="flex justify-between items-center pt-4">
        <Button variant="outline" onClick={onBack}>&larr; Back: Smart Charging</Button>
