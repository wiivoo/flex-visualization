...
| PROJ-44 | Azure Deployment & Review Hardening | Deployed | [spec](PROJ-44-azure-deployment-and-review-hardening.md) | `README.md`, `Dockerfile`, `azure-pipelines.yml`, `docs/review/`, `docs/deployment/` |
| PROJ-45 | PV + Battery Rolling Replay Planner | In Review | [spec](PROJ-45-pv-battery-rolling-replay-planner.md) | `src/app/battery/calculator/`, `src/components/battery/calculator/`, `src/lib/pv-battery-calculator.ts`, `src/lib/pv-battery-rolling-replay.ts`, `docs/battery/` |
| PROJ-46 | Shared-Secret Access Gate | In Review | [spec](PROJ-46-shared-secret-access-gate.md) | `src/proxy.ts` |
